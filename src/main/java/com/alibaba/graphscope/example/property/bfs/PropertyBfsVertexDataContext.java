...
public class PropertyBfsVertexDataContext extends LabeledVertexDataContext<Long, Double>
    ...
    public void init(
        ...
        depth = new LongArrayWrapper(fragment.getTotalVerticesNum(0), Long.MAX_VALUE);
    ...
    public void Output(ArrowFragment<Long> fragment) {
        ...
        String prefix = "/tmp/bfs_default_output_" + timeStamp;
