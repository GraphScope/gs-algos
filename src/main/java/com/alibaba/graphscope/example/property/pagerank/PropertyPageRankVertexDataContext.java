...
public class PropertyPageRankVertexDataContext
    extends LabeledVertexDataContext<Long, Double>
    implements PropertyDefaultContextBase<Long> {
    private static Logger logger =
        LoggerFactory.getLogger(PropertyPageRankVertexDataContext.class.getName());
    public double delta;
    ...
    public void Output(ArrowFragment<Long> frag) {
        String prefix = "/tmp/pagerank_default_output" + (System.currentTimeMillis() / 1000);
